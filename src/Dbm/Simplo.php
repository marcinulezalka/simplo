...
namespace Simplysmart\Simplo\Dbm;

use App\Utils\VersionManager;
use Simplysmart\Simplo\App\Services\SimploService;

/**
 * 🚀 Klasa Simplo – prosty przykładowy CLI dla Webemo DBM
 *
 * Obsługuje komendy:
 *   🛠️ update
 *   🛠️ update:release
...
{
    /**
     * Nazwa vendora (np. webemo, simplysmart, itp.)
     * @var string
     */
    protected string $vendorName = 'webemo';
    ...
    {
        echo "\n";
        echo "SIMPLO - $this->vendorName DBM - dostępne komendy:\n\n";
